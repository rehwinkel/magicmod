...
public class BlockRegistry {
    ...
    public static void registerBlocks(RegistryEvent.Register<Block> event) {
        ...
        SILT_STONE = new Block(
                Block.Properties.create(Material.ROCK, MaterialColor.WHITE_TERRACOTTA).hardnessAndResistance(3.0F))
        ...
        STONE_TABLET = new StoneTabletBlock(Block.Properties.from(SILT_STONE)).setRegistryName("stone_tablet");
        event.getRegistry().registerAll(WAND_TABLE, AMETHYST_ORE, AMETHYST_SILT_ORE, SILT_STONE, SILT_STONE_BRICKS,
                ...
                SILT_STONE_BRICK_WALL, AMETHYST_BLOCK, STONE_TABLET);
    }
